...
"""Generic evaluation script that evaluates a model using a given dataset.
    If --mode=periodic is specified,
    If --mode=all is specified, the script reads the text file named checkpoint that is stored in
...
tf.app.flags.DEFINE_string(
  'mode', None,
  'mode=periodic to evaluate all checkpoints concurrently with training. '
